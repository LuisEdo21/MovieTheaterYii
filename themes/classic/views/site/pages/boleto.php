...
<section id="boleto">
    <h1>Aquí está tu boleto - Movie Theater: El cine como nunca lo imaginaste</h1>
    <h4>Imprime esta página y pasa directamente a la sala sin pasar por taquilla.</h4>
    <div class="row" align="center">
        <?php
            ...
            if($registro = mysql_fetch_array($ObtieneIDPelicula))
            {
                ...
                $ConsultaImporte = sprintf("Select ImporteVenta from ventas where IDVenta=%d",$IDVen);
                ...
                $ImporteVen = $registroImporte['ImporteVenta'];
                ...
                echo "<h2><strong>Código de venta: </strong>".$IDVen."</h2>";

                echo "<h2><strong>TOTAL: </strong>$".$ImporteVen.".00</h2>";
            }
         ?>
    </div>
</section>